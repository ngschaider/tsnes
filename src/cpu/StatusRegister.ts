...
export default class StatusRegister {
    ...
    fromUint8(byte: uint8) {
        this.C = (byte & 0b00000001) !== 0;
        this.Z = (byte & 0b00000010) !== 0;
        this.I = (byte & 0b00000100) !== 0;
        this.D = (byte & 0b00001000) !== 0;
        this.B = (byte & 0b00010000) !== 0;
        this.U = (byte & 0b00100000) !== 0;
        this.V = (byte & 0b01000000) !== 0;
        this.N = (byte & 0b10000000) !== 0;
    }
}
