...
import ABS_X from "./addressingModes/ABS_X";
...
import ZP from "./addressingModes/ZP";
import ZP_X from "./addressingModes/ZP_X";
import ZP_Y from "./addressingModes/ZP_Y";
import Accum from "./addressingModes/Accum";
...
const getInstructionByOpcode = (opcode: number) => {
    switch(opcode) {
        ...
        case 0x04: return new NOP(0x04, new Implied(), 3);
        case 0x05: return new ORA(0x05, new ZP(), 3);
        case 0x06: return new ASL(0x06, new ZP(), 5);
        case 0x07: return new XXX(0x07);
        case 0x08: return new PHP(0x08, new Implied(), 3);
        case 0x09: return new ORA(0x09, new IMM(), 2);
        case 0x0A: return new ASL(0x0A, new Accum(), 2);
        case 0x0B: return new XXX(0x0B);
        case 0x0C: return new NOP(0x0C, new Implied(), 4);
        case 0x0D: return new ORA(0x0D, new ABS(), 4);
        case 0x0E: return new ASL(0x0E, new ABS(), 6);
        case 0x0F: return new XXX(0x0F);
        case 0x10: return new BPL(0x10, new Relative(), 2);
        case 0x11: return new ORA(0x11, new IND_Y(), 5);
        case 0x12: return new XXX(0x12);
        case 0x13: return new XXX(0x13);
        case 0x14: return new NOP(0x14, new Implied(), 4);
        case 0x15: return new ORA(0x15, new ZP_X(), 4);
        case 0x16: return new ASL(0x16, new ZP_X(), 6);
        case 0x17: return new XXX(0x17);
        case 0x18: return new CLC(0x18, new Implied(), 2);
        case 0x19: return new ORA(0x19, new ABS_Y(), 4);
        case 0x1A: return new NOP(0x1A, new Implied(), 2);
        case 0x1B: return new XXX(0x1B);
        case 0x1C: return new NOP(0x1C, new Implied(), 4);
        case 0x1D: return new ORA(0x1D, new ABS_X(), 4);
        case 0x1E: return new ASL(0x1E, new ABS_X(), 7);
        case 0x1F: return new XXX(0x1F);
        case 0x20: return new JSR(0x20, new ABS(), 6);
        case 0x21: return new AND(0x21, new IND_X(), 6);
        case 0x22: return new XXX(0x22);
        case 0x23: return new XXX(0x23);
        case 0x24: return new BIT(0x24, new ZP(), 3);
        case 0x25: return new AND(0x25, new ZP(), 3);
        case 0x26: return new ROL(0x26, new ZP(), 5);
        case 0x27: return new XXX(0x27);
        case 0x28: return new PLP(0x28, new Implied(), 4);
        case 0x29: return new AND(0x29, new IMM(), 2);
        case 0x2A: return new ROL(0x2A, new Accum(), 2);
        ...
        case 0x30: return new BMI(0x30, new Relative(), 2);
        case 0x31: return new AND(0x31, new IND_Y(), 5);
        case 0x32: return new XXX(0x32);
        case 0x33: return new XXX(0x33);
        case 0x34: return new NOP(0x34, new Implied(), 4);
        case 0x35: return new AND(0x35, new ZP_X(), 4);
        case 0x36: return new ROL(0x36, new ZP_X(), 6);
        case 0x37: return new XXX(0x37);
        case 0x38: return new SEC(0x38, new Implied(), 2);
        case 0x39: return new AND(0x39, new ABS_Y(), 4);
        case 0x3A: return new NOP(0x3A, new Implied(), 2);
        case 0x3B: return new XXX(0x3B);
        case 0x3C: return new NOP(0x3C, new Implied(), 4);
        case 0x3D: return new AND(0x3D, new ABS_X(), 4);
        case 0x3E: return new ROL(0x3E, new ABS_X(), 7);
        case 0x3F: return new XXX(0x3F);
        case 0x40: return new RTI(0x40, new Implied(), 6);
        case 0x41: return new EOR(0x41, new IND_X(), 6);
        case 0x42: return new XXX(0x42);
        case 0x43: return new XXX(0x43);
        case 0x44: return new NOP(0x44, new Implied(), 3);
        case 0x45: return new EOR(0x45, new ZP(), 3);
        case 0x46: return new LSR(0x46, new ZP(), 5);
        case 0x47: return new XXX(0x47);
        case 0x48: return new PHA(0x48, new Implied(), 3);
        case 0x49: return new EOR(0x49, new IMM(), 2);
        case 0x4A: return new LSR(0x4A, new Accum(), 2);
        ...
        case 0x50: return new BVC(0x50, new Relative(), 2);
        case 0x51: return new EOR(0x51, new IND_Y(), 5);
        case 0x52: return new XXX(0x52);
        case 0x53: return new XXX(0x53);
        case 0x54: return new NOP(0x54, new Implied(), 4);
        case 0x55: return new EOR(0x55, new ZP_X(), 4);
        case 0x56: return new LSR(0x56, new ZP_X(), 6);
        case 0x57: return new XXX(0x57);
        case 0x58: return new CLI(0x58, new Implied(), 2);
        case 0x59: return new EOR(0x59, new ABS_Y(), 4);
        case 0x5A: return new NOP(0x5A, new Implied(), 2);
        case 0x5B: return new XXX(0x5B);
        case 0x5C: return new NOP(0x5C, new Implied(), 4);
        case 0x5D: return new EOR(0x5D, new ABS_X(), 4);
        case 0x5E: return new LSR(0x5E, new ABS_X(), 7);
        case 0x5F: return new XXX(0x5F);
        case 0x60: return new RTS(0x60, new Implied(), 6);
        case 0x61: return new ADC(0x61, new IND_X(), 6);
        case 0x62: return new XXX(0x62);
        case 0x63: return new XXX(0x63);
        case 0x64: return new NOP(0x64, new Implied(), 3);
        case 0x65: return new ADC(0x65, new ZP(), 3);
        case 0x66: return new ROR(0x66, new ZP(), 5);
        case 0x67: return new XXX(0x67);
        case 0x68: return new PLA(0x68, new Implied(), 4);
        ...
        case 0x70: return new BVS(0x70, new Relative(), 2);
        case 0x71: return new ADC(0x71, new IND_Y(), 5);
        case 0x72: return new XXX(0x72);
        case 0x73: return new XXX(0x73);
        case 0x74: return new NOP(0x74, new Implied(), 4);
        case 0x75: return new ADC(0x75, new ZP_X(), 4);
        case 0x76: return new ROR(0x76, new ZP_X(), 6);
        case 0x77: return new XXX(0x77);
        case 0x78: return new SEI(0x78, new Implied(), 2);
        case 0x79: return new ADC(0x79, new ABS_Y(), 4);
        case 0x7A: return new NOP(0x7A, new Implied(), 2);
        case 0x7B: return new XXX(0x7B);
        case 0x7C: return new NOP(0x7C, new Implied(), 4);
        case 0x7D: return new ADC(0x7D, new ABS_X(), 4);
        case 0x7E: return new ROR(0x7E, new ABS_X(), 7);
        case 0x7F: return new XXX(0x7F);
        case 0x80: return new NOP(0x80, new Implied(), 2);
        case 0x81: return new STA(0x81, new IND_X(), 6);
        case 0x82: return new NOP(0x82, new Implied(), 2);
        case 0x83: return new XXX(0x83);
        case 0x84: return new STY(0x84, new ZP(), 3);
        case 0x85: return new STA(0x85, new ZP(), 3);
        case 0x86: return new STX(0x86, new ZP(), 3);
        case 0x87: return new XXX(0x87);
        case 0x88: return new DEY(0x88, new Implied(), 2);
        case 0x89: return new NOP(0x89, new Implied(), 2);
        case 0x8A: return new TXA(0x8A, new Accum(), 2);
        ...
        case 0x90: return new BCC(0x90, new Relative(), 2);
        case 0x91: return new STA(0x91, new IND_Y(), 6);
        case 0x92: return new XXX(0x92);
        case 0x93: return new XXX(0x93);
        case 0x94: return new STY(0x94, new ZP_X(), 4);
        case 0x95: return new STA(0x95, new ZP_X(), 4);
        case 0x96: return new STX(0x96, new ZP_Y(), 4);
        case 0x97: return new XXX(0x97);
        case 0x98: return new TYA(0x98, new Implied(), 2);
        case 0x99: return new STA(0x99, new ABS_Y(), 5);
        case 0x9A: return new TXS(0x9A, new Implied(), 2);
        case 0x9B: return new XXX(0x9B);
        case 0x9C: return new NOP(0x9C, new Implied(), 5);
        case 0x9D: return new STA(0x9D, new ABS_X(), 5);
        case 0x9E: return new XXX(0x9E);
        case 0x9F: return new XXX(0x9F);
        case 0xA0: return new LDY(0xA0, new IMM(), 2);
        case 0xA1: return new LDA(0xA1, new IND_X(), 6);
        case 0xA2: return new LDX(0xA2, new IMM(), 2);
        case 0xA3: return new XXX(0xA3);
        case 0xA4: return new LDY(0xA4, new ZP(), 3);
        case 0xA5: return new LDA(0xA5, new ZP(), 3);
        case 0xA6: return new LDX(0xA6, new ZP(), 3);
        case 0xA7: return new XXX(0xA7);
        case 0xA8: return new TAY(0xA8, new Implied(), 2);
        case 0xA9: return new LDA(0xA9, new IMM(), 2);
        case 0xAA: return new TAX(0xAA, new Implied(), 2);
        ...
        case 0xB0: return new BCS(0xB0, new Relative(), 2);
        case 0xB1: return new LDA(0xB1, new IND_Y(), 5);
        case 0xB2: return new XXX(0xB2);
        case 0xB3: return new XXX(0xB3);
        case 0xB4: return new LDY(0xB4, new ZP_X(), 4);
        case 0xB5: return new LDA(0xB5, new ZP_X(), 4);
        case 0xB6: return new LDX(0xB6, new ZP_Y(), 4);
        case 0xB7: return new XXX(0xB7);
        case 0xB8: return new CLV(0xB8, new Implied(), 2);
        case 0xB9: return new LDA(0xB9, new ABS_Y(), 4);
        case 0xBA: return new TSX(0xBA, new Implied(), 2);
        case 0xBB: return new XXX(0xBB);
        case 0xBC: return new LDY(0xBC, new ABS_X(), 4);
        case 0xBD: return new LDA(0xBD, new ABS_X(), 4);
        case 0xBE: return new LDX(0xBE, new ABS_Y(), 4);
        case 0xBF: return new XXX(0xBF);
        case 0xC0: return new CPY(0xC0, new IMM(), 2);
        case 0xC1: return new CMP(0xC1, new IND_X(), 6);
        case 0xC2: return new NOP(0xC2, new Implied(), 2);
        case 0xC3: return new XXX(0xC3);
        case 0xC4: return new CPY(0xC4, new ZP(), 3);
        case 0xC5: return new CMP(0xC5, new ZP(), 3);
        case 0xC6: return new DEC(0xC6, new ZP(), 5);
        case 0xC7: return new XXX(0xC7);
        case 0xC8: return new INY(0xC8, new Implied(), 2);
        case 0xC9: return new CMP(0xC9, new IMM(), 2);
        case 0xCA: return new DEX(0xCA, new Implied(), 2);
        ...
        case 0xD0: return new BNE(0xD0, new Relative(), 2);
        case 0xD1: return new CMP(0xD1, new IND_Y(), 5);
        case 0xD2: return new XXX(0xD2);
        case 0xD3: return new XXX(0xD3);
        case 0xD4: return new NOP(0xD4, new Implied(), 4);
        case 0xD5: return new CMP(0xD5, new ZP_X(), 4);
        case 0xD6: return new DEC(0xD6, new ZP_X(), 6);
        case 0xD7: return new XXX(0xD7);
        case 0xD8: return new CLD(0xD8, new Implied(), 2);
        case 0xD9: return new CMP(0xD9, new ABS_Y(), 4);
        case 0xDA: return new NOP(0xDA, new Implied(), 2);
        case 0xDB: return new XXX(0xDB);
        case 0xDC: return new NOP(0xDC, new Implied(), 4);
        case 0xDD: return new CMP(0xDD, new ABS_X(), 4);
        case 0xDE: return new DEC(0xDE, new ABS_X(), 7);
        case 0xDF: return new XXX(0xDF);
        case 0xE0: return new CPX(0xE0, new IMM(), 2);
        case 0xE1: return new SBC(0xE1, new IND_X(), 6);
        case 0xE2: return new NOP(0xE2, new Implied(), 2);
        case 0xE3: return new XXX(0xE3);
        case 0xE4: return new CPX(0xE4, new ZP(), 3);
        case 0xE5: return new SBC(0xE5, new ZP(), 3);
        case 0xE6: return new INC(0xE6, new ZP(), 5);
        case 0xE7: return new XXX(0xE7);
        case 0xE8: return new INX(0xE8, new Implied(), 2);
        case 0xE9: return new SBC(0xE9, new IMM(), 2);
        case 0xEA: return new NOP(0xEA, new Implied(), 2);
        case 0xEB: return new SBC(0xEB, new Implied(), 2);
        ...
        case 0xF0: return new BEQ(0xF0, new Relative(), 2);
        case 0xF1: return new SBC(0xF1, new IND_Y(), 5);
        case 0xF2: return new XXX(0xF2);
        case 0xF3: return new XXX(0xF3);
        case 0xF4: return new NOP(0xF4, new Implied(), 4);
        case 0xF5: return new SBC(0xF5, new ZP_X(), 4);
        case 0xF6: return new INC(0xF6, new ZP_X(), 6);
        case 0xF7: return new XXX(0xF7);
        case 0xF8: return new SED(0xF8, new Implied(), 2);
        case 0xF9: return new SBC(0xF9, new ABS_Y(), 4);
        case 0xFA: return new NOP(0xFA, new Implied(), 2);
        case 0xFB: return new XXX(0xFB);
        case 0xFC: return new NOP(0xFC, new Implied(), 4);
        case 0xFD: return new SBC(0xFD, new ABS_X(), 4);
